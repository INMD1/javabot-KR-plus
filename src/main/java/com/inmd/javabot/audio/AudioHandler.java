 ...
 */
package com.inmd.javabot.audio;
...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            eb.setDescription((audioPlayer.isPaused() ? javabot.PAUSE_EMOJI : javabot.PLAY_EMOJI)
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                ...
                .setDescription(javabot.STOP_EMOJI+" "+FormatUtil.progressBar(-1)+" "+FormatUtil.volumeIcon(audioPlayer.getVolume()))
    ...
    public String getTopicFormat(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            return "**"+title+"** ["+(userid==0 ? "autoplay" : "<@"+userid+">")+"]"
                    + "\n" + (audioPlayer.isPaused() ? javabot.PAUSE_EMOJI : javabot.PLAY_EMOJI) + " "
                    + "[" + FormatUtil.formatTime(track.getDuration()) + "] "
                    + FormatUtil.volumeIcon(audioPlayer.getVolume());
        }
        else return "No music playing " + javabot.STOP_EMOJI + " " + FormatUtil.volumeIcon(audioPlayer.getVolume());
    }
